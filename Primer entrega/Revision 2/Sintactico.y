...
comp_bool:
    MENOR                                               {printf("Regla 41: comp_bool es MENOR\n");}
    |MAYOR                                              {printf("Regla 42: comp_bool es MAYOR\n");}
    |MENOR_IGUAL                                        {printf("Regla 43: comp_bool es MENOR_IGUAL\n");}
    |MAYOR_IGUAL                                        {printf("Regla 44: comp_bool es MAYOR_IGUAL\n");}
    |IGUAL                                              {printf("Regla 45: comp_bool es IGUAL\n");}
    |DISTINTO                                           {printf("Regla 46: comp_bool es DISTINTO\n");};

/* Funciones nativas */

long:
    LONG PA CA lista_exp_coma CC PC                     {printf("Regla 47: long es LONG PA CA lista_exp_coma CC PC\n\n");};


lista_exp_coma:
    lista_exp_coma COMA expresion_aritmetica            {printf("Regla 48: lista_exp_coma es lista_exp_coma COMA expresion_aritmetica\n");}
    | expresion_aritmetica                              {printf("Regla 49: lista_exp_coma es expresion_aritmetica\n");};

lectura:
    GET ID												{
															chequearVarEnTabla($2);
															printf("Regla 50: lectura es GET ID\n");
														};

escritura:
    DISPLAY ID                                            {
															chequearVarEnTabla($2);
															printf("Regla 51: escritura es DISPLAY ID\n");
														}
    | DISPLAY CTE_STRING                                  {
															printf("Regla 52: escritura es DISPLAY CTE_STRING\n\n");
															agregarCteStringATabla(yylval.valor_string);
														};
%%
