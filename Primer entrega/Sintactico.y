...
expresion_logica:
    expresion_logica AND termino_logico                 {printf("Regla 37: expresion_logica es termino_logico AND termino_logico\n");}
    | expresion_logica OR termino_logico                {printf("Regla 38: expresion_logica es termino_logico OR termino_logico\n");}
    | termino_logico                                    {printf("Regla 39: expresion_logica es termino_logico\n");}

termino_logico:
    NOT termino_logico                              	{printf("Regla 40: NOT termino_logico\n");};
