...
%token <string_val>ID
%token <float_val>CONSTANTE_REAL
%token <int_val>CONSTANTE_ENTERA
%token <string_val>CONSTANTE_STRING
...
bloque_if:
    IF expresion_logica bloque ENDIF               {printf("Regla 18: bloque_if es IF expresion_logica THEN bloque ENDIF\n\n");};

bloque_if:
    IF expresion_logica bloque ELSE bloque ENDIF   {printf("Regla 19: bloque_if es IF expresion_logica THEN bloque ELSE bloque ENDIF\n\n");};

bloque_while:
    WHILE expresion_logica bloque              {printf("Regla 20: bloque_while es WHILE expresion_logica bloque ENDWHILE\n\n");};
...
/*LONG:
    AVG PA CA lista_exp_coma CC PC                      {printf("Regla 48: LONG es AVG PA CA lista_exp_coma CC PC\n\n");};
